...
\begin{document}
    ...
    \begin{table}[h!]
        ...
        \resizebox{\columnwidth}{!}{
            \begin{tabular}{ lrrrrrrrrrrrrr  }
                ...
                NPR-DDPM & 32.35 (31.11) & 10.55 (12.86) & 6.18 (8.48) & 4.52 & 3.57 & 4.10 & & 19.94 (21.85) & 7.99 (7.51) & 5.31 (5.21) & 4.52 & 4.10 & 4.27 \\
                SN-DDPM & \textbf{24.06} (23.24) & \textbf{6.91} (6.84) & \textbf{4.63} (5.64) & \textbf{3.67} & \textbf{3.31} & 3.65 & & \textbf{16.33} (17.67) & \textbf{6.05} (7.02) & \textbf{4.17} (4.59) & \textbf{3.83} & \textbf{3.72} & 4.07 \\
                \hline
                ...
                NPR-DDIM & 13.34 (18.43) & 5.38 (9.64) & 3.95 (5.11) & 3.53 & 3.42 & 3.72 & & 22.81 (25.41) & 9.47 (12.82) & 6.04 (7.86) & 5.02 & 5.06 & 4.62 \\
                SN-DDIM & \textbf{12.19} (15.87) & \textbf{4.28} (5.56) & \textbf{3.39} (4.31) & \textbf{3.23} & \textbf{3.22} & \textbf{3.65} & & \textbf{17.90} (19.24) & \textbf{7.36} (8.71) & \textbf{5.16} (5.97) & \textbf{4.63} & \textbf{4.63} & \textbf{4.51} \\
                \hline
            \end{tabular}
        }
        \resizebox{\columnwidth}{!} {
            \begin{tabular}{ lrrrrrrrrrrrrr  }
                ...
                NPR-DDPM & 28.37 (36.56) & 15.74 (19.37) & 10.89 (12.39) & 8.23 & 7.03 & 5.33 & & 28.27 (37.96) & 20.89 (24.19) & 18.06 (20.17) & 16.96 & \textbf{16.32} & 16.38 \\
                SN-DDPM & \textbf{20.60} (25.77) & \textbf{12.00} (14.32) & \textbf{7.88} (9.21) & \textbf{5.89} & \textbf{5.02} & 4.42 & & \textbf{27.58} (33.75) & \textbf{20.74} (22.43) & \textbf{18.04} (20.01) & \textbf{16.61} & 16.37 & \textbf{16.22} \\
                \hline
                ...
                NPR-DDIM & 14.98 (18.46) & 8.93 (10.22) & 6.04 (7.05) & 4.27 & 3.59 & 3.15 & & 28.84 (33.47) & 19.62 (22.09) & 17.63 (19.17) & 17.42 & 17.30 & 18.91 \\
                SN-DDIM & \textbf{10.20} (12.09) & \textbf{5.48} (6.10) & \textbf{3.83} (4.91) & \textbf{3.04} & \textbf{2.85} & \textbf{2.90} & & 28.07 (31.12) & 19.38 (20.05) & \textbf{17.53} (19.35) & \textbf{17.23} & \textbf{17.23} & \textbf{18.89} \\
                \hline
            \end{tabular}
        }
        \begin{center}
            \resizebox{9.5cm}{!}{
                \begin{tabular}{ lrrrrrr  }
                    ...
                    NPR-DPM & 33.70 (36.01) & 10.44 (12.25) & 5.83 (7.33) & 3.97 & 3.05 & 3.04 \\
                    SN-DPM & \textbf{25.30} (36.01) & \textbf{7.34} (12.25) & \textbf{4.46} (7.02) & \textbf{3.27} & \textbf{2.83} & 2.71 \\
                    \hline
                \end{tabular}
            }
        \end{center}
        ...
        \begin{center}
            \resizebox{\columnwidth}{!}{
                \begin{tabular}{llrrrrrrrrrrrrr}
                    ...
                    & NPR-DDPM & \textbf{5.40} (7.25) & \textbf{4.64} (5.62) & \textbf{4.25} (5.02) & \textbf{3.98} & \textbf{3.79} & \textbf{3.57} & & \textbf{5.03} (6.41) & \textbf{4.33} (5.17) & \textbf{3.99} (4.85) & \textbf{3.76} & \textbf{3.59} & \textbf{3.41} \\
                    \hline
                    ...
                    & NPR-DDPM & \textbf{3.91} (5.41) & \textbf{3.64} (4.92) & \textbf{3.59} (3.81) & \textbf{3.58} & \textbf{3.57} & \textbf{3.57} & & \textbf{3.88} (5.05) & \textbf{3.52} (4.40) & \textbf{3.45} (3.85) & \textbf{3.42} & \textbf{3.41} & \textbf{3.41} \\
                    \hline
                \end{tabular}
            }
        \end{center}
        \begin{center}
            \resizebox{\columnwidth}{!}{
                \begin{tabular}{llrrrrrrrrrrrrr}
                    ...
                    & NPR-DDPM & \textbf{4.46} (6.02) & \textbf{3.78} (4.24) & \textbf{3.40} (3.81) & \textbf{3.11} & \textbf{2.89} & \textbf{2.65} & & \textbf{4.66} (6.52) & \textbf{4.22} (5.37) & \textbf{3.96} (4.47) & \textbf{3.80} & \textbf{3.71} & \textbf{3.60} \\
                    \hline
                    ...
                    & NPR-DDPM & \textbf{2.88} (4.47) & \textbf{2.69} (4.12) & \textbf{2.66} (3.65) & \textbf{2.66} & \textbf{2.65} & \textbf{2.65} & & \textbf{3.73} (4.27) & \textbf{3.65} (3.77) & \textbf{3.62} (3.62) & \textbf{3.60} & \textbf{3.60} & \textbf{3.60} \\
                    \hline
                \end{tabular}
            }
        \end{center}
    ...
    \subsection{Mô hình khuếch tán biến phân (VDMs)}
