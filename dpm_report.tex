...
\begin{document}
    ...
    \subsection{Khuếch đại sai lệch}
    ...
    \begin{table}[h!] \label{table:Details-of-Pretrained-Noise-Prediction-Network}
    ...
    \begin{table}[h!] \label{table:Structures-Details-of-Prediction-Network}
    ...
    \subsection{Chi tiết về chi phí bộ nhớ và chi phí thời gian}

    Trong bảng, ta liệt kê chi phí bộ nhớ và chi phí thời gian của các mô hình (tương ứng với các phương pháp) được sử dụng trong thực nghiệm.
    ...
    Theo \cite{nichol2021improved}, \cite{bao2021}
