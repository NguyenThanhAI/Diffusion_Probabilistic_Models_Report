...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \item $\sum_{n=1}^{N-1} \mathbb{E}_{q(\boldsymbol{x}_{n-1}, \boldsymbol{x}_{n+1} \vert \boldsymbol{x}_0)} \lbrack D_{\mathrm{KL}} \big( q(\boldsymbol{x}_n \vert \boldsymbol{x}_{n-1}) \Vert p_{\boldsymbol{\theta}} (\boldsymbol{x}_n \vert \boldsymbol{x}_{n+1}) \big) \rbrack$ là thành phần nhất quán.
