...
\begin{document}
        ...
        \begin{center}
            \resizebox{11cm}{!}{
                \begin{tabular}{ lrrr}
                    ...
                    Improved DDPM \cite{nichol2021improved} &  45 (5.96) & Không có mô hình & 90 (6.02) \\
                    Analytic-DPM \cite{bao2021analytic} &  25 (5.81) & 55 (5.98) & 100 (6.05) \\
                    NPR-DPM &  1.002 x 23 (5.76) & 1.011 x 50 (6.04) &  1.017 x 90 (6.01) \\
                    SN-DPM &  1.005 x 17 (5.81) & 1.012 x 22 (5.96) & 1.100 x 92 (6.02) \\
                    \hline
                \end{tabular}
            }
        \end{center}
    ...
    có thể ước lượng được bằng cực tiếu hóa hàm mục tiêu MSE.
